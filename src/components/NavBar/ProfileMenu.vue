...
<template>
    <div v-if="!auth.user.isAuthenticated" class="relative px-1 py-1">
        ...
        <button @click="openRegister = !openRegister" class="font-bold">REGISTER</button>
        <button @click="open = !open" class="font-bold pl-3">SING IN</button>
    </div>
    ...
    <div v-else role="menu" class="relative px-1 py-1">
        ...
        <Menu as="div" class="relative ml-3">
            ...
            <transition enter-active-class="transition ease-out duration-100"
                ...
                <MenuItems
                    ...
                    <a href="/profile"
                        :class="[active ? 'bg-gray-100' : '', ' px-4 py-2 text-sm text-gray-700 flex flex-row']">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
        ...
        <!-- <ul v-if="isPopoverOpen" data-popover="profile-menu" data-popover-placement="bottom"
            class="absolute z-10 min-w-[150px] overflow-auto rounded-lg border border-slate-200 bg-white p-1.5 shadow-lg focus:outline-none">
