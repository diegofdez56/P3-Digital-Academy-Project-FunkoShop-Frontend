...
<template>
    <div class="relative px-1 py-1">
        ...
        <ul role="menu" v-if="isPopoverOpen" data-popover="profile-menu" data-popover-placement="bottom"
            ...
            <li role="menuitem"
                class="cursor-pointer text-slate-800 flex w-full text-sm items-center rounded-md p-3 transition-all hover:bg-slate-100 focus:bg-slate-100 active:bg-slate-100">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-slate-400">
                            <path fill-rule="evenodd"
