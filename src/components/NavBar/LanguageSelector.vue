...
<template>
  <Menu as="div" class="relative inline-block text-left">
    <div>
      <MenuButton class="inline-flex w-full justify-center items-center gap-x-1.5 rounded-md bg-transparent border-2 border-white px-2 py-1 text-sm font-semibold text-gray-900">
        <img
    ...
    <transition enter-active-class="transition ease-out duration-100"
      ...
      <MenuItems class="absolute right-0 z-10 mt-2 w-15 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
        <div class="py-1">
