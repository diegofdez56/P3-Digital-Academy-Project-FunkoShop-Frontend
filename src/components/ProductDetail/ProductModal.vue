...
import Groot from '/src/assets/img/CardImage/Groot.png';
...
const product = {
  ...
  imageSrc: Groot,
  imageAlt: 'FukoPop.',
  description: "Lorem ipsum blablablablalablablablaalbla lorem blablablablbla lorem lorem lorem lr.",
};
                ...
                <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                  ...
                  <div class="sm:col-span-8 lg:col-span-7">
                    ...
                    <section aria-labelledby="information-heading" class="mt-2">
                      ...
                      <h3 class="text-2xl text-gray-900 font-semibold">{{ product.price }}</h3>
                      <div>
                    ...
                    <section aria-labelledby="options-heading" class="mt-10">
                      ...
                      <div class="mt-6 flex items-center space-x-4">
                        <button @click="decrementQuantity"
                          class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">-</button>
                      ...
                      <form>
                        <button type="submit"
                          class="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Add
                          to bag</button>
                      </form>
                    </section>
                  </div>
