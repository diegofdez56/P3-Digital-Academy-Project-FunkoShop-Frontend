                ...
                <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                  ...
                  <div class="sm:col-span-8 lg:col-span-7">
                    <div class="flex place-items-baseline justify-between pr-10">
                      ...
                      <BadgeCard class="w-24" :id="product.name" :isAvailable="product.available"
                      ...
                      <div class="mt-4">
                        ...
                        <div class="flex mt-1">
                          <button @click="decrementQuantity"
                            class="px-2 py-1 border rounded-l-md bg-gray-200 hover:bg-gray-300">-</button>
                          <input type="text" id="quantity" class="border-t border-b border-gray-300 w-16 text-center"
                            v-model="quantity" readonly />
                          <button @click="incrementQuantity"
                            class="px-2 py-1 border rounded-r-md bg-gray-200 hover:bg-gray-300">+</button>
                        </div>
                      </div>
                      <div class="mt-6">
                        <button type="button"
